...
public:
    ...
    virtual std::vector<std::pair<int, double>> getPlaylistSongs(int id) const = 0;
    ...
    virtual std::vector<PlaylistSongEntity> addSongsToPlaylist(std::vector<PlaylistSongEntity>& songs) = 0;
